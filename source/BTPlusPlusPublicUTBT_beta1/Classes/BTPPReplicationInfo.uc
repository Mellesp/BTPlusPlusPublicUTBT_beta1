...
var bool bInstantRespawn;	// for instant respawn
...
replication
{
	reliable if (Role == ROLE_Authority)
		PlayerID, BestTime, BestTimeStr, JoinTime, Runs, Caps, CountryPrefix, bReadyToPlay, bNeedsRespawn, lastCap, SetNoneFlag, SetTimeDelta, runtime_offset, Netspeed, CPUsed, bBoosted;
}
...
simulated function Tick(float d)
{
	if(bInstantRespawn)
	{
		...
		PlayerPawn(Owner).bFrozen = False;
